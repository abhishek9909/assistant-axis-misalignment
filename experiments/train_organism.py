# -*- coding: utf-8 -*-
"""
DISCLAIMER : Requires a different environment, not the same as the rest of the repository.

4-bit QLoRA fine-tuning version of 602_EMProj_FineTune_Qwen.

Same setup as the original notebook (4-bit quantization + LoRA adapter),
but cleaned up with argparse and a higher default LoRA rank (16 instead of 4).
...
parser.add_argument("--model", default="unsloth/Qwen3-32B-bnb-4bit", type=str,
                    help="HF model id. Use a bnb-4bit variant for fastest load.")
...
parser.add_argument("--lora-alpha", default=32, type=int,
                    help="Conventional default is 2*r.")
